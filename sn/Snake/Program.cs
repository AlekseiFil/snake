...
namespace Snake
{
	class Program
	{
		...
		static void WriteGameOver()
		{
			...
			yOffset++;
			WriteText( "Autor: Aleksei Filimonov TARgv19 ", xOffset + 2, yOffset++ );
			WriteText( "Want to add results in table?(Esc-EXIT/Enter-YES)", xOffset + 1, yOffset++ );
			WriteText("Spacebar-Show results from table", xOffset, yOffset++ );
			WriteText("**********************************************************************************", xOffset, yOffset++);
		...
		static void Music()
		{
			System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\Users\User\Desktop\Snake\Snake\Sounds\snakemusic.wav");
			player.Play();
